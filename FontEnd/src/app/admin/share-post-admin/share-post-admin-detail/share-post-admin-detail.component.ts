...
@Component({
  selector: 'app-share-post-admin-detail',
  templateUrl: './share-post-admin-detail.component.html',
  styleUrls: ['./share-post-admin-detail.component.css']
})
export class SharePostAdminDetailComponent implements OnInit {
  ...
  ngOnChanges(changes: SimpleChanges) {
    this.postshare = changes['postshare'].currentValue;
  }
