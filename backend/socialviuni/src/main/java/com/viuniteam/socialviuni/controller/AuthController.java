		...
		public class AuthController {
			...
			public ResponseEntity<?> createAuthenticationToken(@RequestBody JwtRequest authenticationRequest,
				...
				if (httpServletRequest != null) {
					BrowserSaveRequest browserSaveRequest = BrowserSaveRequest.builder().ip(httpServletRequest.getRemoteAddr())
							.browser(httpServletRequest.getHeader("User-Agent")).user(userService.findOneByUsername(username))
							.build();
