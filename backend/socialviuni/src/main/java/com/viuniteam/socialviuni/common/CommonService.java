package com.viuniteam.socialviuni.common;

import com.viuniteam.socialviuni.entity.BaseChatEntity;
import com.viuniteam.socialviuni.entity.BaseEntity;
...
public class CommonService {
     ...
     * @param <T>    Entity
     */
    public <T extends BaseChatEntity> void setCommonCreatedEntity(T entity) {
     ...
     * @param <T>    Entity
     */
    public <T extends BaseChatEntity> void setCommonUpdateEntity(T entity) {
